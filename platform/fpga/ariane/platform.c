...
static int ariane_final_init(bool cold_boot)
{
  ...
  csr_write(CSR_MHPMEVENT9,PERF_OUT_EXT_EVT_00);
  csr_write(CSR_MHPMEVENT10,PERF_OUT_EXT_EVT_01);
  csr_write(CSR_MHPMEVENT11,PERF_OUT_EXT_EVT_02);
  csr_write(CSR_MHPMEVENT12,PERF_OUT_EXT_EVT_03);
  csr_write(CSR_MHPMEVENT13,PERF_OUT_EXT_EVT_04);
  csr_write(CSR_MHPMEVENT14,PERF_OUT_EXT_EVT_05);
  csr_write(CSR_MHPMEVENT15,PERF_OUT_EXT_EVT_06);
  csr_write(CSR_MHPMEVENT16,PERF_OUT_EXT_EVT_07);
